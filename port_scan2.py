...
while True:
    ...
    try:
        ...
        elif "리다이렉션 되는 URL 넣어주세요" in response.url:
        ...
        elif "보안정책에 따라 차단" in response.text:
...
# IP 입력 안되는거 해결
# 콘솔기반 - 프로그램 기반으로 포팅
# 함수 형식으로 재구성 필요, 재구성시 IP , 도메인 주소는 main에서 input 하는 형식으로 진행할것4
# output 방식 딕셔너리 형식으로 메인으로 넘길것
